...
//
// Solidity: function requests(bytes32 id) view returns((bytes32,string,string,address,uint256,bool,(bytes32,bytes32,bytes,address,uint256)[],uint8,uint8))
